...
➡ **[Download AnalogtoKey_Setup_v0.45.exe](https://github.com/Gallinarius/AnalogtoKey/releases/latest)**
...
- **Button modifier keys** — add Ctrl / Shift / Alt to any button mapping via a dropdown (e.g. Button 1 → Ctrl+A)
...
- **Per-axis key hold duration** — configure hold time (ms) independently per axis
...
1. Download `AnalogtoKey_Setup_v0.45.exe` from [Releases](https://github.com/Gallinarius/AnalogtoKey/releases/latest)
